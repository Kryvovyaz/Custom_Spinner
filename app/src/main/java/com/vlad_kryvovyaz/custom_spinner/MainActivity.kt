package com.vlad_kryvovyaz.custom_spinner
    ...
    private fun setupCustomSpinner() {
        ...
        customSpinner.onItemSelectedListener = object: AdapterView.OnItemSelectedListener {
            override fun onItemSelected(parent: AdapterView<*>?, view: View?, position: Int, id: Long) {
                ...
                val selectedItem = Countries.list!![position]
                Toast.makeText(this@MainActivity, "${selectedItem .name.toString()} Selected", Toast.LENGTH_SHORT).show()
            }
